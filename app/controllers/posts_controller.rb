class PostsController < ApplicationController
  ...
  def show                #since i'm setting the user and post before the show route, don't need to put anything here.
  ...
  def post_params  
    params.require(:post).permit(:image, :caption)     #get the params out of the form (permit only the image and caption, so other info can't be passed into the form)
  end  
end
